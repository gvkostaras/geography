...
maxH2=window.innerHeight-120;
document.getElementById("mb1").style.height=maxH2/5+"px";
document.getElementById("mb2").style.height=maxH2/9+"px";
document.getElementById("mb3").style.height=maxH2/9+"px";

document.getElementById("mb4").style.height=maxH2/9+"px";
document.getElementById("mb5").style.height=maxH2/9+"px";
document.getElementById("mb6").style.height=maxH2/9+"px";
